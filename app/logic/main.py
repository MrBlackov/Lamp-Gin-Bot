...
from app.db.metods.gets import get_chat_for_id, get_chat_for_tg_id, get_chat_setting_for_id
...
class ChatLogic:
    ...
    async def redact_is_msg_delete(self, chat_id: int, is_msg_delete: bool):
        setting = await update_chat_setting_by_chat_id(chat_id=chat_id, is_msg_delete=is_msg_delete)
        return await self.info(setting.chat_id)
    
    async def redact_msg_delete_time(self, chat_id: int, msg_delete_time: int):
        setting = await update_chat_setting_by_chat_id(chat_id=chat_id, msg_delete_time=msg_delete_time)
        return await self.info(setting.chat_id)
