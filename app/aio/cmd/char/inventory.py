...
@log.decor(arg=True)
@call_exept
async def callback_add_char_names(callback: CallbackQuery, callback_data: InventoryItemsCall, state: FSMContext):
...
@log.decor(arg=True)
@call_exept
async def callback_add_char_names(callback: CallbackQuery, callback_data: InventoryItemsGoCall, state: FSMContext):
...
@log.decor(arg=True)
@call_exept
async def callback_add_char_names(callback: CallbackQuery, callback_data: InventoryItemsActionCall, state: FSMContext):
...
@log.decor(arg=True)
@call_exept
async def callback_add_char_names(callback: CallbackQuery, callback_data: InventoryItemsPickUpCall, state: FSMContext):
    msg, markup = await Character(callback.from_user.id, state).inventory.look_location_item(callback_data.item_id)
    await callback.message.edit_text(msg, reply_markup=markup)
