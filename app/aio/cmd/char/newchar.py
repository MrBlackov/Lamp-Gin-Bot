...
async def cmd_handler(message: Message, state: FSMContext, **kwargs):
    msg, markup = await Character(message.from_user.id, state).new.chouse_gender()
...
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharBackCall | MenuCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.chouse_gender()
...
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharBonusCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.chouse_gender_bonus()
    await callback.message.edit_text(msg, reply_markup=markup)
...
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharGenderCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.menu(callback_data.gender)
    await callback.message.edit_text(msg, reply_markup=markup)
...
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharBackCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.menu()
    await callback.message.edit_text(msg, reply_markup=markup)
...
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharActionCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.to_skills()
    await callback.message.edit_text(msg, reply_markup=markup)
...
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharSkillCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.skills(callback_data.skill_tag, callback_data.level, callback_data.is_base)
    await callback.message.edit_text(msg, reply_markup=markup)
...
@call_exept(tips=new_char_tips, rarity_tips=0.3)
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharActionCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.to_add_skills()
    await callback.message.edit_text(msg, reply_markup=markup)
...
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharPageSkillCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.to_page_skills(callback_data.page)
    await callback.message.edit_text(msg, reply_markup=markup)
...
@call_exept(tips=new_char_tips, rarity_tips=0.3)
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharActionCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.to_rename(callback_data.name_type)
    await callback.message.edit_text(msg, reply_markup=markup)
...
@call_exept(tips=new_char_tips, rarity_tips=0.3)
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharBackCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.to_rename()
    await callback.message.edit_text(msg, reply_markup=markup)
...
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharNameActionCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.to_random_name(callback_data.name_type)
    await callback.message.edit_text(msg, reply_markup=markup)
...
@call_exept(tips=new_char_tips, rarity_tips=0.3)
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharNameActionCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.to_query_names(callback_data.name_type, callback.message)
    await callback.message.edit_text(msg, reply_markup=markup)
...
async def cmd_handler(message: Message, state: FSMContext, **kwargs):
    ...
    msg, markup = await Character(message.from_user.id, state).new.query_names(message.text)
...
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharPageNameCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.to_page_names(callback_data.page)
    await callback.message.edit_text(msg, reply_markup=markup)
...
@call_exept(tips=new_char_tips, rarity_tips=0.3)
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharNameActionCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.rename(None, 'last')
    await callback.message.edit_text(msg, reply_markup=markup)
...
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharNameCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.rename(callback_data.name, callback_data.name_type)
    await callback.message.edit_text(msg, reply_markup=markup)
...
@call_exept(tips=new_char_tips, rarity_tips=0.3)
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharActionCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.to_description(callback.message)
    await callback.message.edit_text(msg, reply_markup=markup)
...
async def cmd_handler(message: Message, state: FSMContext, **kwargs):
    fsm = CharFSM(state, 'new')
    msg0 = await fsm.get_value('msg')
    msg, markup = await Character(message.from_user.id, state).new.descript(message.text)
    msg2 = await message.answer(msg, reply_markup=markup)
    await fsm.update_data(msg=msg2)
    await fsm.set_state()
    await msg0.delete()
...
@call_exept(tips=new_char_tips, rarity_tips=0.3)
async def callback_to_new_item_faq(callback: CallbackQuery, callback_data: NewCharActionCall, state: FSMContext, **kwargs):
    msg, markup = await Character(callback.from_user.id, state).new.create(callback_data.is_finished)
    await callback.message.edit_text(msg, reply_markup=markup)
