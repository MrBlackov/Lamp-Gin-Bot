...
class ChatIKB(BotIKB):
    ...
    def menu(self, chat_id: int, is_msg_delete: bool):
        ...
        self.builder.button(text='❌ Выключить удаление сообщений по таймеру', callback_data=ChatSettingActionCall(chat_id=chat_id, is_msg_delete=False, tg_id=self.tg_id))
