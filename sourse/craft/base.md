...
![Список крафтов](./img/base/crafts.png){width=70%}

Ищем нужный крафт и открываем его

![Крафт](./img/base/craft.png){width=70%}
...
![Успешный крафт](./img/base/to_craft.png){width=70%}

Если же не хвататет ингредиентов или нету инструменты то:

![Нехватка ингредиентов или отсуствие инструмента](./img/base/error_quantity.png){width=70%}

<!--craft-end-->

---

## ✏️ Результат с нужным количеством

Если вас нужно другое количество результата крафта, нажмите кнопку `✒️ Указать другое количество`

![Указываем нужное количество](./img/base/quantity.png){width=70%}

Отправляем нужное количество крафтов

![Крафт с нужным количевстом результата](./img/base/craft_x3.png){width=70%}
...
![Пример крафта](./img/base/craft2.png){width=70%}

![Пример крафта](./img/base/craft3.png){width=70%}

![Пример крафта](./img/base/craft4.png){width=70%}

![Пример крафта](./img/base/craft5.png){width=70%}