...
![Выбираем пол](./img/newchar/gender.png){width=60%}

Мы получаем такое сообщение

![Информация о будущем персонаже](./img/newchar/menu.png){width=70%}
...
![Предупреждение о конвертации ОН в 💷 Фунты (Игровую валюту)](./img/newchar/finish.png){width=80%}
...
![Выбираем способ изменения имени](./img/newchar/name.png){width=80%}

или на кнопку `♣️ Фаимилия`

![Выбираем способ изменения фамилии](./img/newchar/last_name.png){width=80%}

Если нужно конкретное имя/фамилия, то нажимаем на `🔎 Поиск` и отправляем боту часть имени/фамилии:

![Выбираем способ изменения имени](./img/newchar/query.png){width=80%}

> ❗ Если имя/фамилия на английском, то важно, чтобы его часть была тоже на английском.

>  Например, если нужно James вводим Ja.

![Ищем нужное имя](./img/newchar/name_page_1.png){width=80%}

Перелистываем и нажимаем на нужное имя/фамилию.

![Нажимаем на нужное имя](./img/newchar/name_page_2.png){width=80%}

Также можно выбрать сулчайное имя:

![Выбираем понравившиеся имя](./img/newchar/random.png){width=80%}
...
Если хотим добавить дополнительный навык

![Изменяем навыки как нам нужно](./img/newchar/add_skills.png){width=60%}
