...
![Выбираем пол](./img/newchar/gender.png)

Мы получаем такое сообщение

![Информация о будущем персонаже](./img/newchar/menu.png)
...
![Предупреждение о конвертации ОН в 💷 Фунты (Игровую валюту)](./img/newchar/finish.png)
...
## ✏️ Изменение имени и фамилии {#name}
...
![Выбираем способ изменения имени](./img/newchar/name.png)

или на кнопку `♣️ Фаимилия`

![Выбираем способ изменения фамилии](./img/newchar/last_name.png)

Если нужно конкретное имя/фамилия, то нажимаем на `🔎 Поиск` и отправляем боту часть имени/фамилии:

![Выбираем способ изменения имени](./img/newchar/query.png)

> ❗ Если имя/фамилия на английском, то важно, чтобы его часть была тоже на английском.

>  Например, если нужно James вводим Ja.

![Ищем нужное имя](./img/newchar/name_page_1.png)

Перелистываем и нажимаем на нужное имя/фамилию.

![Нажимаем на нужное имя](./img/newchar/name_page_2.png)

Также можно выбрать сулчайное имя:

![Выбираем понравившиеся имя](./img/newchar/random.png)

---

## 💡 Изменение навыков создаваемого персонажа {#skills}
...
![Изменяем навыки как нам нужно](./img/newchar/skills.png)

Если хотим добавить дополнительный навык

![Изменяем навыки как нам нужно](./img/newchar/add_skills.png)

Нажимаем на навык, который хотим изменить. 

![Изменяем уровень навыка](./img/newchar/skill.png)
...
![Ошибка при уменьшении уровня базового навыка ниже определенного ](./img/newchar/error_base_skill.png)
